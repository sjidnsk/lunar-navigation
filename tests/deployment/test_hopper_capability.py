...
CAPABILITY = ROOT / "deployment/config/hopper.yaml"


def test_hopper_v1_is_complete_parametric_runtime_capability() -> None:
    """Catches a deployment baseline that drifts from approved Hopper inputs."""
    ...
    assert document["hopper"] == {
        ...
        "reference_remaining_usable_fuel_mass_kg": 0.2,
