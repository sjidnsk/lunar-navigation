...
EXPECTED_HEADERS = {
    "lunar_pure_planner_core/global_goal_feasibility.hpp",
    ...
    "lunar_pure_planner_core/types/planning_request.hpp",
    "lunar_pure_planner_core/types/platform_capability.hpp",
    "lunar_pure_planner_core/types/world_snapshot.hpp",
}
FORBIDDEN_PATTERNS = {
...
def check_headers(include_root: Path, compiler: str) -> list[str]:
    ...
    package_include_root = include_root / "lunar_pure_planner_core"
