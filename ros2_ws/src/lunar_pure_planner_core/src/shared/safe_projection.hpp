...
public:
  ...
  [[nodiscard]] GridSearchProjectionView GridSearchView() const & noexcept;
  GridSearchProjectionView GridSearchView() const && = delete;
  [[nodiscard]] operator GridSearchProjectionView() const & noexcept {
    return GridSearchView();
  }
  operator GridSearchProjectionView() const && = delete;
