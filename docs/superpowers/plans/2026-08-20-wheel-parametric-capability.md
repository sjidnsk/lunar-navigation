...
wheeled:
  ...
  motion_primitives:
    ...
    - primitive_id: forward-arc-left
      kind: FORWARD_ARC
      relative_end_pose: {position_m: [0.019603428065912, 0.000963054665561, 0.0], orientation_wxyz: [0.998795456205172, 0.0, 0.0, 0.049067674327418]}
    ...
    - primitive_id: spin-left
      ...
      relative_end_pose: {position_m: [0.0, 0.0, 0.0], orientation_wxyz: [0.998795456205172, 0.0, 0.0, 0.049067674327418]}
