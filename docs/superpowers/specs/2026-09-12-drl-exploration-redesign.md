...
创建：2026-09-12；统一修订：2026-09-15，含 30 倍仿真及并行/学习参数确认。状态：设计交付，尚未实施本版算法、训练或部署。
...
性能分项记录真值初始化、地图导出、任务分析、图更新、Actor 推理、导航执行、SGD、保存及内存峰值。30 倍为目标，8 环境在本机是否达到该倍率需要测量。`γ=1`、低温度、固定成本及较长局部决策链可能带来价值估计与学习速度问题，不能承诺固定转移数收敛。
