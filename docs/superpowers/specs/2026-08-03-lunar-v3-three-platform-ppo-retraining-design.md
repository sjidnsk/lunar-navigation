...
> 2026-08-09 现行修订：本文的单网络、三平台课程、86400 GPU seconds 上限与分平台 95% 门仍
> 有效；网络输入 shape、正式场景任务域、无固定决策上限、checkpoint/resume 和自然终态评估以
> `2026-08-09-unbounded-formal-episode-design.md` 为准。旧 pose `[B,6]` 与早期 checkpoint 表述
> 只保留为设计沿革。
